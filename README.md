...
## Deploy CloudFormation Drift Detection application
...
```bash
tools-cloudformmation-drift-detection$ sam local invoke ScheduledEventLogger --event events/event-cloudwatch-event.json
```
...
```bash
tools-cloudformmation-drift-detection$ npm install
tools-cloudformmation-drift-detection$ npm run test
```
